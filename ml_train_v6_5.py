#!/usr/bin/env python3
"""
ML选股模型训练 V6.5 — V6.2 + V6.3 精选特征（去零贡献 + 去冗余）
...
MODEL_PATH = os.path.join(DATA_DIR, 'ml_stock_model_v6_5.pkl')
FEATURE_CONFIG_PATH = os.path.join(DATA_DIR, 'feature_config_v6_5.json')
