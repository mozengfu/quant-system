#!/usr/bin/env python3
"""
ML选股模型训练 V8.6 — V6 核心特征精简集

只使用 V6 基础 52 特征 + 12 个排名特征，排除 v6.2/v6.3 噪声特征
"""
...
MODEL_PATH = os.path.join(DATA_DIR, 'ml_stock_model_v8_6.pkl')
FEATURE_CONFIG_PATH = os.path.join(DATA_DIR, 'feature_config_v8_6.json')
